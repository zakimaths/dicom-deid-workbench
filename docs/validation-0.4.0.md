...
- Six complete local hospital-record flows: Chromium, Firefox and WebKit, at 1440 and 390 pixels. Imported UTF-8 text and PNG files; selected Unicode text manually; preserved manual selections when suggesting again; checked downloaded TXT and every pixel in saved PNGs; exercised full-size viewing and malformed-import recovery.
